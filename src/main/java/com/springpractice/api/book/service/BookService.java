...
public class BookService {
    ...
    public Page<BookWithPaginationResponseDTO> getBookWithPagination(Pageable pageable, Long bookId) {
        return bookRepository.findBookWithPagination(pageable, bookId);
    }
}
